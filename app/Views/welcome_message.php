                ...
                <section id="section-teams" class="page-section">
                    <div class="container">
                        <div class="heading-block center">
                            ...
                            <span>Kenali dekat individu luar biasa di tim Sahabat Agro. Setiap tokoh membawa kontribusi unik yang tak hanya menentukan kekuatan tim, tetapi juga membentuk karakter dan dedikasi kami pada pelayanan masyarakat. Sertai perjalanan ini untuk memahami lebih dalam para pemimpin di balik visi dan pencapaian kami</span>
                        </div>
                        <br>
                        <div class="row justify-content-center col-mb-50">
                            <div id="oc-team-list" class="owl-carousel team-carousel carousel-widget" data-margin="30" data-nav="false" data-items-xs="1" data-items-sm="2" data-items-md="3">
                                <?php foreach ($list_team as $team) { ?>
                                    <div class="oc-item">
                                        <div class="team">
                                            <div class="team-image">
                                                <img src="<?= base_url() ?>public/uploads/landing/original/<?= $team->filename ?>" alt="John Doe" />
                                            </div>
                                            <div class="team-desc">
